...
export default function Home() {
  ...
  const confirmLevelUp = () => {
    ...
    if (!newHPRoll || isNaN(hpRollValue) || hpRollValue < 1 || hpRollValue > 8) {
      alert('Por favor, insira um valor válido entre 1 e 8 para a rolagem do d8.');
      return;
    }
          ...
          <div className="space-y-6">
            <div className="rounded-lg border-2 border-green-700/50 bg-gradient-to-br from-green-950/20 to-neutral-900 p-4 shadow-lg">
              ...
              <p className="mb-4 text-sm text-neutral-400">
                Cada vez que o cão sobe de nível, você rola 1d8 e adiciona o modificador de CON (+
                ...
                {companion.hpHistory.map((entry) => (
                  ...
                  >
                    ...
                    <span className="text-neutral-300">
                      {entry.roll} <span className="text-xs text-neutral-500">(d8)</span> +{' '}
          ...
          <div className="w-full max-w-md rounded-lg border border-amber-700/50 bg-neutral-900 p-6">
            ...
            <div className="mb-6">
              ...
              <p className="mb-3 text-sm text-neutral-300">
                Role 1d8 e insira o resultado. Seu modificador de CON será adicionado automaticamente.
              </p>
              <label className="mb-2 block text-sm font-semibold text-amber-200">Resultado do d8:</label>
              <input
                type="number"
                inputMode="numeric"
                min="1"
              ...
              <div className="mt-3 rounded-lg border border-green-700/50 bg-neutral-950 p-3 text-center">
                <div className="text-sm text-neutral-400">
                  {newHPRoll || 0} (d8) + {companion.attributes.constitution.modifier} (CON) ={' '}
